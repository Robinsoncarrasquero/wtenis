...
$sexo=(isset($_GET['sexo'])) ? htmlspecialchars($_GET['sexo']) : null;
$estatus=(isset($_GET['estatus'])) ? htmlspecialchars($_GET['estatus']) : null; // Inscrito o Retirado
$chk="checked";
$chkpagado=0;
...
<!--    <script type="text/javascript" src="../js/jquery/1.15.0/dist/jquery.validate.js"></script>-->
    ...
    <body>
        ...
        <form name="frm" <?php echo $hidden ?> method="GET" action="<?PHP echo$_SERVER['PHP_SELF']?>" >
            <label for="t">Torneo Ej:(20181G21216MIR) </label> 
            <input type="text" name="t" required="required" value="<?php echo $codigo_torneo; ?>"/><br />
         ...
         <a > <img id="Logo" src="../images/logo/fvtlogo.png"   ></a>
