...
if(isset($_SESSION['logueado']) and !$_SESSION['logueado'] && $_SESSION['niveluser']<8 ){
...
if ($_SESSION['niveluser']==99 || $_SESSION['niveluser']==8 ){
   $empresa_id=0;
}
$mes=$_POST['mes'];
//sleep(1);
                ...
                <div class="table-responsive">
                    <div  class="table">      
                        ...
                        foreach ($rsColeccion_Torneos as $row) {
                                if (($row['arbitro']==$_SESSION['atleta_id'] && $_SESSION['niveluser']==8)
...
//                                echo '<td>'
//                                    . '<a href="bsTorneo_Update.php" target="_blank" data-id="'.$row['torneo_id'].'" class="disabled update-record glyphicon glyphicon-edit">Editar</a></br>'
