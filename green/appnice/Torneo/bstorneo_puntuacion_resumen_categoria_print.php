...
$categoria=htmlspecialchars($_GET['catid']); // Categoria
$sexo=  htmlspecialchars($_GET['sexo']); // Categoria

$objTorneo = new Torneo();
$objTorneo->Fetch($torneo_id);
$la_categoria=$objTorneo->getCategoria();
$entidad = $objTorneo->getEntidad();
$ObjAtleta = new Atleta();
$ObjAtleta->Find($objTorneo->getArbitro());
$arbitro=  $ObjAtleta->getID()>0 ? $ObjAtleta->getNombreCompleto() : "POR ASIGNAR";
$jugadores=  TorneosInscritos::Count_Categoria($torneo_id, $categoria, $sexo);
$objEmpresa = new Empresa();
$objEmpresa->Fetch($entidad);
...
$strTitle= $strHTML .'
                ...
                <div>
                    ...
                    <p><b>ENTIDAD: </b>'.fun_Estado($entidad).'<b>      ARBITRO :</b>'.$arbitro.'</p> 
                </div>';
