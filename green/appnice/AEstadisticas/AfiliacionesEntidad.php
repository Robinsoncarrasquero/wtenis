  ...
  <body>
    ...
    <div class="container-fluid">
            ...
            ?>
             <br><br>
             <hr>
             <h1> Afiliaciones Entidad</h1>
                      
            <!-- Nav tabs -->
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"  class="active"><a href="#tabfiltro" aria-controls="tabfiltro" role="tab" data-toggle="tab">Filtro</a></li>
                <li role="presentation" ><a href="#tabestado" aria-controls="tabestado" role="tab" data-toggle="tab">Federadas</a></li>
                <li role="presentation" ><a href="#tabregion" aria-controls="tabregion" role="tab" data-toggle="tab">Transito</a></li>
                <li role="presentation" ><a href="#tabcategoria" aria-controls="tabcategoria" role="tab" data-toggle="tab">Categorias Federadas</a></li>
                <li role="presentation" ><a href="#tabpais" aria-controls="tabpais" role="tab" data-toggle="tab">Categorias Transito</a></li>
...
$(document).ready(function() {
    ...
    $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
        ...
        if (x==="Federadas"){
          GenGoogleChartBar("edofed");
        }
        if (x==="Transito"){
          GenGoogleChartBar('edotra');
        }
        if (x==="Categorias Federadas"){
          GenGoogleChartBar('catfed');
        }
        if (x==="Categorias Transito"){
          GenGoogleChartBar('cattra');
        }
    ...
    function GenGoogleChartBar(optt)
    {
        ...
        //if (Confirmar("Esta Seguro de Procesar "+ ano + " Disciplina "+disciplina))
        {
            ...
            method: "POST",
            url: "Procesar.php", 
            data: { ano:ano,disciplina:disciplina,opt:opt,glbempresa:'aso',proceso:proceso}
            })
            .done(function( jsdata ) {
                ...
                if (opt==="edo" && proceso=="fed")
                {
                    // Set chart options
                    var mcolors=['#0000ff','#669900','#800080','#000080','#0000ff'];
                    var options =SetChartOptions("Afiliaciones Por Entidad Federadas",'ESTADO', '#000000',mcolors);
                
                }
                if (opt==="edo" && proceso=="tra")
                {
                    // Set chart options
                    var mcolors=['#669900','#800080','#000080','#0000ff'];
                    var options =SetChartOptions("Afiliaciones por Entidad en Transito",'ESTADO', '#777777',mcolors);
                
                }
                if (opt==="cat" && proceso=='fed')
                {
                    // Set chart options
                    var mcolors=['#800080','#FF9900','#800080','#0000ff'];
                    var options =SetChartOptions("Afiliaciones por Categoria Federadas",'CATEGORIAS', '#000000',mcolors);
                }
                
                if (opt==="cat" && proceso=='tra')
                {
                    // Set chart options
                    var mcolors=['#6600FF','#800080','#0000ff','#FF9900'];
                    var options =SetChartOptions("Afiliaciones Por Categoria en Transito",'CATEGORIAS', '000000',mcolors);
                }
