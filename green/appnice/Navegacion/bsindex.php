...
//    echo 'dominio ' . htmlspecialchars(isset($_GET["asociacion"])? $_GET["asociacion"]:"nada") . '!';
...
if (!$objEmpresa->Operacion_Exitosa()) {
    $_SESSION['asociacion']='VEN'; // ASOCIACION 
    $objEmpresa->Fetch($_SESSION['asociacion']);
    $_SESSION['empresa_id']=$objEmpresa->get_Empresa_id();
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    if (isset($_SESSION['logueado']) and $_SESSION['logueado']){
                       echo ' <li><a href="bsPanel.php">Panel</a></li>';
                       echo ' <li><a href="sesion_cerrar.php">Cerrar Sesion</a></li>';
                    }else{
                       echo '<li><a href="Login.php">Login</a></li>';
                    }
...
echo (jumbotron($objEmpresa->getNombre(), $objEmpresa->getDescripcion()));
...
<section class="main container">
    <div class="row">
        ...
        <section class="post-fijo post-fijo-img-slide col-xs-12 col-md-8 ">
    ...
    echo ' <div id="Carousel_galery" class="carousel slide" data-ride="carousel" data-interval="2000" data-pause="hover">
            ...
            <div class="left carousel-inner" role="listbox">';
            //Creamos una carpeta de imagenes por estado
             for ($i=0;$i<4;$i++){
                $x=$i + 1;
                $img =$_SESSION['url_fotos']."/slide-".$x.".jpg";
                ...
                echo  '<img src="'.$img.'" alt="Competidores" >
...
?>
 ...
 </section> <!-- Fin de section de container main
