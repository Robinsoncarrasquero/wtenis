...
<div class="container-fluid">  
    ...
    <div >
            <h2 class="text text-center" >Ranking Por Fecha</h2>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content col-xs-12  ">
              <div class="modal-header">
                ...
                <div class="col-xs-10">
                    <h5>Tenista :<span class="text text-danger" id="header"></span></h5>
                </div>

                <div class="col-xs-12">
                    <h5>Puntos :<span class="text text-danger" id="puntos"></span></h5>
                </div>
