...
{ 
   ...
   <div class="container-fluid">
            ...
            <div class="col-sx-12">
                <h3>Formalizacion de Afiliados <?php echo $ano_afiliacion ?>  </h3>  
            </div>
...
$(document).ready(function() {
    ...
    $('#btn-buscar').click(function(e){
        ...
        $.post("bsAfiliacionesFormalizacionLoadLista.php",
            {id:id,chkFiltro:chkFiltro,pagina:0}, 
            function(data){
                if (data.Success){
    ...
    $(document).on('click','.page-link',function(e)  {
        ...
        $.ajax({
            method: "POST",
            url: "bsAfiliacionesFormalizacionLoadLista.php", 
            data: { id:id,chkFiltro:chkFiltro,pagina:page}
        })
        .done(function( data) {
