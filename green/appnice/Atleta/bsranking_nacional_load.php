...
$categoria_id=$_POST['catid']; // Categoria
$estado=$_POST['estado'];
switch ($categoria_id) {
    case 1:
        $categoria='12';
...
//                                        }
                                        ...
                                        echo '<td >'. $nr.'</td>';    
                                        $hash= $row['ranking_id'];
                                        $href="bsRankingDetail.php?rkdetail=".$hash;
                                        $lk="<a target='_blank' href='".$href."'</a>".'<b class="badge">'. $row['puntos'].'</b>';
                                        echo '<td >'.$lk.'</td>';
