...
<div class="form-group hidden">
 ...
 <div class="form-group col-xs-12">
    <button type="button" id="close" value="close" class="btn btn-default btn-lg btnbtn">Close</button>
    <input type="submit"  id="'.$operacion.'" value="'.$operacion.'" class="btn btn-primary btn-lg  btnbtn"> 
