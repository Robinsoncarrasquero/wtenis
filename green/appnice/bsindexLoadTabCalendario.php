        ...
        foreach ($rsColeccion_Torneos as $row) {
            ...
            if ($status_filtro==$estatus){
               $strData="";
                ...
                $strData .= "<td data-toggle='tooltip' data-placement='auto' title='Fechas del Torneo'>"
                . ""
                . "<p class='fechacierre'>Cierre: $fecha_cierre</p>"
                . "<p class='fecharetiro'>Retiro: $fecha_retiro</p>"
                . "<p class='fechainicio'>Inicio: $fecha_inicio</p>"
                . ""
                . "</td>";
                /* fecha de torneo
...
if ($strDataHTML==''){
	...
	//$jsondata= array("Success"=>TRUE,"Mensaje"=>"Informacion disponible",HTML=>$objTorneo->getMensaje());
